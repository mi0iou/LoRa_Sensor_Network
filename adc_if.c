...
/* Private Functions Definition -----------------------------------------------AIR QUALITY LEVEL */
/* USER CODE BEGIN PrFD */
uint16_t SYS_GetAirQualityLevel(void)
{
  uint16_t airqualityLevelmV = 0;
  uint32_t measuredLevel = 0;

  measuredLevel = ADC_ReadChannels(ADC_CHANNEL_5);

  airqualityLevelmV = measuredLevel * 3300/4095;

  return airqualityLevelmV;
}
